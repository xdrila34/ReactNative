...
const StudentScreen = () => {
    return (
        <View style={styles.container}>
            ...
            <StudentDetalis name="Donart" image={require('../assets/avatar3.jpg')} description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s"></StudentDetalis>
            <StudentDetalis name="Dyll" image={require('../assets/avatar4.jpg')} description="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s"></StudentDetalis>
